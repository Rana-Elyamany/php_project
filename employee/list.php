...
<h1 class="text-center text-light display-1 mt-5 pt-5">List Employee Page</h1>
                    ...
                    <tr>
                        ...
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item text-success"  href="/com/employee/edit.php?edit=<?=$data['id']?>"><i class="fa-sharp fa-solid fa-pen-to-square"></i></a></li>
